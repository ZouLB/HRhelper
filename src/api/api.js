...
//删除邮件
export const removeMail = params => { return axios.get(`${base}/mail/del`, { params: params }); };

//批量删除邮件
export const batchRemoveMail = params => { return axios.get(`${base}/mail/patch_del`, { params: params }); };
